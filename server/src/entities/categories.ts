...
export const insertCategorySchema = categoriesSchema.omit({id:true, createdByUserId: true, isDefault:true})
export const categoriesKeysAll = Object.keys(
  categoriesSchema.shape
) as (keyof Categories)[]

export const categoriesKeysPublic = ['id', 'title', 'createdByUserId', 'groupId', 'isDefault'] as const
