...
export async function up(db: Kysely<any>) {
    ...
    .addColumn('task_id', 'integer', (c)=> c.references('tasks.id').onDelete('cascade').notNull())
    .addColumn('completed_at', 'timestamptz', (c)=> c.notNull().defaultTo(sql`CURRENT_TIMESTAMP`))
